...
function inline_css_fe(){
 ...
 $theme_options_styles = '';
  if ( $eo_options["use_dropcaps"] == "1") {
	 $theme_options_styles .= 'p:first-child:first-letter {float: left; font-size: 3em; line-height: 2.4em; padding-top: 0.1em; padding-right: 0.2em; padding-left: 0.1em; }';
  }
...
//	var_dump($ftg);	
	...
	//	var_dump($eo_googlefonts_arr);
		...
		if($eo_googlefonts_arr) {
			$gwf_face_variants = array();
			foreach ( $eo_googlefonts_arr as $fslug =>$gwf_face ) {
